const fs = require('fs')
fs.writeFileSync('app/lib/processImage.ts', `export async function processImage(file: File, options: { whiteBackground: boolean, bgTolerance: number }): Promise<string> {
